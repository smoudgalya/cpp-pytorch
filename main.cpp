...
at::Tensor inferOneImage(std::string imageFullPath)
{
  ...
  cv::resize(cvimg, resizedImg, cv::Size(75, 100));

  cv::cvtColor(resizedImg, resizedImg, CV_BGR2RGB);
  ...
  std::string filename = "/home/sm/Documents/work/dl/cpp-pytorch/libtorch_Modified_banded_w_grand_best_achieved_acc.pt";
